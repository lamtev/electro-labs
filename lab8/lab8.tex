...
\begin{figure}[H]
\begin{center}
	\includegraphics[width=0.81\textwidth]{wait.jpg}
	\captionsetup{margin=0cm}
	\caption{Временная диаграмма ждущего генератора} 
	\label{fig:diff}
\end{center}
\end{figure}

\begin{displaymath}
	\gamma_1 = \frac{R_1}{R_1 + R_2} = \frac{2 \cdot 10^4}{2 \cdot 10^4 + 2 \cdot 10^4} = 0.5
\end{displaymath}

\begin{displaymath}
	\gamma_2 = \frac{R_1 || R_\text{Д}}{R_1 || R_\text{Д} + R_2} = \frac{\left(\frac{1}{R_1} + \frac{1}{R_\text{Д}}\right)^{-1}}{\left(\frac{1}{R_1} + \frac{1}{R_\text{Д}}\right)^{-1} + R_2} = \frac{6666.7}{6666.7 + 2 \cdot 10^4} = 0.25
\end{displaymath}
