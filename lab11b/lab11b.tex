...
\begin{displaymath}
K_\text{н.}^I = \frac{\Delta U_\text{вых} \cdot I_\text{н.ном}}{\Delta I_\text{н} \cdot U_\text{вых.ном}} = \frac{0.01 \cdot 0.1}{0.36 \cdot 6} \approx 4.6 \cdot 10^{-4}
\end{displaymath}
...
Полученные в ходе работы зависимости соответсвуют теории.
