...
При установлении на схеме сопротивления резистора $R_1 = 91.26$ кОм, которое было посчитано с использованием заданного значения $h_{21} = 12$, значение $U_\text{кэа} = 4.12$ В, что имеет отклонение не выше $\pm 10 \%$ от заданного - 4 В. Поэтому $h_{21}$ не нуждается в уточнении.


Получив экспериментальное значение $R_\text{вх} = 293.2$ Ом и с учётом того, что $h_{11\text{Э}} \simeq R_\text{вх}$, вычислим уточнённое значение $K_{U0}$: 
