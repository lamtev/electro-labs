...
\begin{flalign*}
K_\text{ст} = \frac{R_\text{бал} \cdot U_\text{вых}}{r_\text{ст} \cdot U_\text{вх}} \geq \frac{230.769 \cdot 9}{46 \cdot 15} = 3.01
\end{flalign*}
...
\begin{flalign*}
K_\text{ст} = \frac{\Delta U_\text{пит}}{\Delta U_\text{ст}} = \frac{24.60 - 11.05}{5.58 - 5.23} = 38,72
\end{flalign*}
...
$R_\text{вых\ \ эксп} = 10.57 $ Ом $< R_\text{вых\ \ теор} \simeq r_\text{ст} \leq 46$ Ом

$K_\text{ст} \sim \frac{1}{r_\text{ст}} \Rightarrow K_\text{ст\ \ эксп}$ должно быть $\geq K_\text{ст\ \ теор} = 3.01$
