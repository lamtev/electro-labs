...
\begin{flalign*}
R_\text{вых} = \frac{r_\text{ст}}{R_\text{бал}} = \frac{46}{230.769} = 0.2
\end{flalign*}
...
\begin{flalign*}
K_\text{ст} = \frac{\Delta U_\text{вх} \cdot U_\text{вых}}{\Delta U_\text{вых} \cdot U_\text{вх}}
\end{flalign*}

\begin{flalign*}
K_\text{ст} = \frac{\Delta U_\text{вых}}{\Delta I_\text{вых}}
\end{flalign*}
